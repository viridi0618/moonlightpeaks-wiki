...
"romance-guide": {
    ...
    sections: [
      ...
      { heading: "Romance pays off — literally", paragraphs: ["One detail worth knowing: building relationships feeds back into your broader progress. Getting close to the locals isn't just for the story — the more people you befriend, the more the town opens up, and it rewards spreading your attention across the whole roster rather than just your favourite."] },
...
"fallen-tree": {
    ...
    sections: [
      ...
      { heading: "Step-by-step checklist", bullets: ["1. Advance 'The Mysterious Bay' until the task prompts you to clear access.", "2. Go to Webb of Wonders and buy the Aborascend spell from Sabrina.", "3. Ensure you have enough mana before leaving town — the spell takes mana to cast.", "4. Travel to Moonlit Pines. Find Luna's seed cart as a landmark.", "5. Walk west of the nearby stairs — you'll see a small waterfall blocked by a fallen tree.", "6. Stand near the log and cast Aborascend to move it.", "7. Continue through the cleared path to progress the quest."] },
      { heading: "How to get Aborascend", paragraphs: ["Aborascend is sold by Sabrina at Webb of Wonders. If it is not listed yet, continue your wand and magic quests and check again. The spell is part of normal spell progression and does not require special materials."] },
      { heading: "Common mistakes to avoid", bullets: ["Do not search the Howling Marshes — the tree is in Moonlit Pines, not the swamp.", "Do not search Luna Bay itself before clearing the route — you cannot reach it yet.", "Do not spend all mana on watering magical crops before the trip — Aborascend requires mana.", "Do not guess the spell pattern repeatedly. If you've forgotten it, check the in-game almanac.", "If Aborascend is not in Sabrina's shop, guides suggest advancing the wand repair quest first; the often-reported Night 18 timing may vary by version or quest order."] }
    ],
    faqs: [ { question: "Which quest uses the fallen tree?", answer: "The Mysterious Bay." }, { question: "Which spell moves the tree?", answer: "Aborascend, purchased from Sabrina at Webb of Wonders." }, { question: "Is the tree in Howling Marshes?", answer: "No. It is in Moonlit Pines, near Luna's seed cart and cottage." }, { question: "Why can't I find the tree?", answer: "Make sure you are west of the stairs near Luna's cart, not deeper into Moonlit Pines." } ],
...
"spells-guide": {
      ...
      { heading: "Every spell we can confirm",
        table: { headers: ["Spell", "Effect", "How to unlock", "Cost"],
          rows: [
            ...
            ["Aborascend I", "Lift fallen trees and wooden obstacles", "Buy from Sabrina at Webb of Wonders", "TBD"],
    ...
    faqs: [ { question: "How do I unlock spells?", answer: "Guides say visit Luna around Night 18, then Noel repairs your wand. You get Aquaflux and spellcasting. Timing varies with your pace." }, { question: "Where do I get Aborascend?", answer: "Buy from Sabrina at Webb of Wonders after the wand quest. It's the spell everyone needs for the fallen tree and similar obstacles." }, { question: "How do I increase mana?", answer: "Craft the Mana Extractor (community sources report 5 Refined Stone + 5 Planks + 5 Copper Bar + 5 Glass + 5 Iron Bar + 10 Rose Quartz) and have Sabrina tune it. Some upgrades also need Rose Quartz from the Crystal Caves." }, { question: "When can I get the Witch's Wand?", answer: "Guide sources report ~5,000g from Sabrina, unlocking Aquaflux II for ~48 crops. Verify the current price in your game." } ],
